    ...
    <section id="hero" className="hero-shell pt-[80px]">
      ...
      <div className="hero-container">
        <div className="hero-row">
          {/* LEFT */}
          <div className="hero-left">
            {/* MODIFICATION: Combined the first line to include "ARE" and used h1 for consistent styling */}
            <h1 className="hero-h1">TOGETHER WE ARE</h1>
            {/* MODIFICATION: Changed h2 to a div with the same styling as h1, or ensured h2 has the right size */}
